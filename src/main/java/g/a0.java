...
public class a0 extends ImageView {
    ...
    public final boolean hasOverlappingRendering() {
        return ((((ImageView) this.f1042b.f1263b).getBackground() instanceof RippleDrawable) ^ true) && super.hasOverlappingRendering();
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        z zVar = this.f1042b;
        if (zVar != null && drawable != null && !this.f1043c) {
